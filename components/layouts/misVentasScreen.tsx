            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6 flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Historial de tus ventas realizadas</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <Card className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Ventas de hoy</p>
                            <p className="text-3xl font-bold text-gray-900 dark:text-white">{totalVentasHoy}</p>
                        </div>
                    ...
                    <Card className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Total vendido hoy</p>
                ...
                {error && (
                    <div className="flex flex-col items-center justify-center py-8">
                        ...
                        <Button variant="secondary" onClick={fetchMisVentas} className="mt-4">Reintentar</Button>
                    </div>
                )}
